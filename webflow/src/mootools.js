...
window.addEvent('domready', function() {
 $$('img.ov').each(function(img) {
var src = img.getProperty('src');
var extension = src.substring(src.lastIndexOf('.'),src.length)
img.addEvent('mouseenter', function() { img.setProperty('src',src.replace(extension,'_on' + extension)); });	img.addEvent('mouseleave', function() { img.setProperty('src',src); });});});

window.addEvent('domready', function() {
 $$('input.ov').each(function(input) {
var src = input.getProperty('src');
var extension = src.substring(src.lastIndexOf('.'),src.length)
input.addEvent('mouseenter', function() { input.setProperty('src',src.replace(extension,'_on' + extension)); });	input.addEvent('mouseleave', function() { input.setProperty('src',src); });});});
